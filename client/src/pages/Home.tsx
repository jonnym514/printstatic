    ...
    <section className="container py-16">
      <div className="max-w-2xl mx-auto text-center">
        ...
        <p className="text-muted-foreground mb-8">
          Subscribe to get a free printable download every Friday — plus early access to new products and exclusive discounts.
        </p>
        {subscribed ? (
          ...
          <div className="order-1 md:order-2 relative mt-4 md:mt-0">
            ...
            <div className="relative rounded-sm overflow-hidden border border-border shadow-2xl ml-4 z-10" style={{ aspectRatio: '4/3' }}>
              ...
              <div className="absolute bottom-4 left-4 bg-white/95 backdrop-blur-sm border border-border rounded-sm px-4 py-3 shadow-lg">
                ...
                <p className="text-xs text-muted-foreground">Instant digital download</p>
              </div>
            ...
            <div className="absolute -bottom-5 -right-4 bg-white border border-border rounded-sm px-4 py-3 shadow-xl z-20 hidden md:block">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-xs font-bold text-foreground" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>Print-Ready PDFs</p>
                  <p className="text-xs text-muted-foreground" style={{ fontFamily: "'Space Mono', monospace" }}>300_dpi</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="relative rounded-sm px-8 py-12 md:py-16 text-center overflow-hidden ink-section">
          ...
          <div className="relative z-10">
            ...
            <p className="text-white/60 text-base mb-8 max-w-md mx-auto">
              Premium digital templates, ready to download and print. Join the community of creators, planners, and makers who run on Print Static.
            </p>
            <Link href="/shop">
              <button
